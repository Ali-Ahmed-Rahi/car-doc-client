          ...
          <form  onSubmit={handleSubmit} noValidate="" action="" className="space-y-6 font-semibold">
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                id="email"
                placeholder="Email"
                className="w-full px-4 py-3 rounded-md border text-black focus:border-default-400"
              />
            </div>
            <div className="space-y-1 text-sm">
            ...
            <button className="block w-full p-3 text-center  text-white bg-orange-600 rounded-lg">
              Login
            </button>
          </form>
